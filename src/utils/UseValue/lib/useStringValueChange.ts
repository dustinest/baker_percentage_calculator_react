...
export const useStringValueChange = (value: string | null | undefined, historyDepth?: number) =>
...
export const useStringInputValueChange = (value: string | null | undefined, historyDepth?: number) =>
